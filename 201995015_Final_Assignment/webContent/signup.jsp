			...
			<div class="sign">
				...
				<h1 style="text-align:center">sign up</h1><br>
					<table align="center">
				      ...
				      <tr>
				          <td width="200"><p align="right">Password-Check</td>
				          <td width="400"><input type="password"  name="pwd_c" required></td>
				      </tr>
				      <tr>
				          <td width="200"><p align="right">Name</td>
				          <td width="400"><p><input type="text"  name="name" required></td>
				      </tr>
				      <tr>
				      ...
				      <tr>
				          ...
				          <td width="400">
								<input type="submit" value="sign up" class="btndesign">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="reset" value="Reset" class="btndesign">
						  </td>
				      </tr>
					</table>
				</div>
