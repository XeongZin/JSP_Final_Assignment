...
<%
	...
	String subtype = "hidden";
	String cantype = "hidden";
	String dis = "disabled";
					...
					<div id="container" align="center">
						<table>
							...
							<tr>
								...
								<td width="400" ><input type="text" name="title" id="titlebox" readonly value="<%=request.getParameter("title")%>"></td>
							</tr>
							<tr>
								<td width="50"><p>content</td>
								<td width="400" ><textarea name="content" id="contentbox" <%=dis %>><%=request.getParameter("content")%></textarea></td>
							</tr>
						</table>
						<input type=<%=subtype %> value="Revise" class="btndesign">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=<%=cantype %> value="Cancel" class="btndesign" onclick="location.href='board.jsp'">
					</div>
					</div>
				</article>
			</section>
