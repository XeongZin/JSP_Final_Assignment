	...
	<body>
		<form method="post" action="post.jsp">
			<div id="container">
				...
				<h3 align="right">ksj is Log In. &nbsp;&nbsp; <a href="logout.jsp" class="newbtn">Log Out</a><a href="meminfo.jsp" class = "newbtn">Mem Info</a></h3> 
			<br>
			<header>
				<hgroup>
					<h1>New Post</h1>
					...
					<div id="container" align="center">
						<table>
							...
							<tr>
								...
								<td width="400" ><input type="text" name="title" id="titlebox"></td>
							</tr>
							<tr>
								<td width="50"><p>content</td>
								<td width="400" ><textarea name="content" id="contentbox"></textarea></td>
							</tr>
						</table>
						<input type="submit" value="Submit" class="btndesign">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="button" value="Cancel" class="btndesign" onclick="location.href='board.jsp'">
						<br><br><br><br>
					</div>
					</div>
				</article>
