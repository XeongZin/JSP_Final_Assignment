...
<html>
	...
	<body>
		<form method="post" action="memcor">
			<div id="container">
				...
				<section class="space">
					<article>
						<div class="sign">
							<div class="signtext">
							<h1 style="text-align:center">Information Correction</h1><br>
								<table align="center">
							      <tr>
							         <td width="200"><p align="right">ID</td>
							         <td width="400"><input type="text" name="id" readonly value="<%= session.getAttribute("id")%>"></td>
							      </tr>
							      <tr>
							      ...
							      <tr>
							          ...
							          <td width="400"><p><input type="text"  name="name" id = "name" required></td>
							      </tr>
							      <tr>
							          <td width="200"><p align="right">E-mail</td>
							          <td width="400"><p><input type="text"  name="email" required></td>
							      </tr>
							      <tr>
							          <td width="200" height="50"><p>&nbsp;</p></td>
							          <td width="400">
											<input type="submit" value="Correction" class="btndesign">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<input type="button" value="Cancel" class="btndesign" onclick="location.href='main.jsp'">
									  </td>
							      </tr>
								</table>
							</div>
